...
class Calculator(QWidget):
    ...
    def initUI(self):
        self.setGeometry(300, 300, 225, 450)
        ...
        self.remainder_div = QPushButton('%', self)
        self.remainder_div.resize(50, 50)
        self.remainder_div.move(5, 320)

        self.int_div = QPushButton('//', self)
        self.int_div.resize(50, 50)
        self.int_div.move(60, 320)

        self.square_int = QPushButton('^2', self)
        self.square_int.resize(50, 50)
        self.square_int.move(115, 320)
        ...
        self.remainder_div.clicked.connect(self.remainder_div_1)
        self.square_int.clicked.connect(self.square_int_1)
